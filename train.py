...
def parse_arg():
    ...
    parser.add_argument('--content', default="test", type=str,
                        help='what is it?')
    parser.add_argument('--label-info', default='label_list/sha-40.txt', type=str,
    ...
    parser.add_argument('--data-dir', default='/media/syc/6162D482A9C8B65A/datasets/MRC-SHA',      
                        help='the directory of the data')

    parser.add_argument('--save-dir', default='history',
                        help='the directory for saving models and training logs')
    parser.add_argument('--warm-up-epochs', default=0, type=int,
                        help='the number of warm-up epochs')
    ...
    parser.add_argument('--weight-decay', type=float, default=4e-5,
                        help='weight decay of student network')
    parser.add_argument('--gta-weight-decay', type=float, default=4e-5,
                        help='weight decay of assistant network')
    parser.add_argument('--lr', default=2e-5, type=float,
                        help='the learning rate of student network')
    parser.add_argument('--gta-lr', default=2e-5, type=float,
                        help='the learning rate of assistant network')
    ...
    parser.add_argument('--start-val', default=0, type=int,
