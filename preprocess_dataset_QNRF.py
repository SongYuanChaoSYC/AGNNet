...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/media/syc/6162D482A9C8B65A/datasets/UCF-QNRF_ECCV18',
                        help='orginal data directory')
    parser.add_argument('--train-list', default='train.txt',
                        help='train list')
    parser.add_argument('--val-list', default='val.txt',
                        help='val list')
    parser.add_argument('--data-dir', default='/media/syc/6162D482A9C8B65A/datasets/MRC-QNRF',
