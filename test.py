...
def parse_arg():
    ...
    parser.add_argument('--data-dir', default='/media/syc/6162D482A9C8B65A/datasets/MRC-SHA/test/',
                        help='the directory of the data')
    parser.add_argument('--model-path', default='/home/syc/实验权重记录/MRC/dropout-0.3.pth',
